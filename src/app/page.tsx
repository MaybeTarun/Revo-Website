...
export default function Home() {
  ...
  return (
    <div className="bg-white w-full min-h-screen flex flex-col">
        ...
        <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-between items-center px-4 md:px-6">
          <Link href="/">
            <div className='flex justify-center items-center gap-1 cursor-pointer'>
              <Revo size={24}/>
              <span className='text-2xl font-medium satoshi md:-mt-1'>revo</span>
            </div>
          </Link>          
      ...
      <div className="h-[8vh] w-full border-y border-black/20">
        <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-start items-end md:items-start px-4 py-2">
          <h1 className='md:hidden font-medium text-lg satoshi'>Features:</h1>
        </div>
      </div>

      <div className="h-fit w-full md:w-[75vw] mx-auto border-x border-black/20 relative">
        <h1 className="absolute hidden md:block left-0 -translate-x-full py-1 px-6 text-sm border-b border-l border-black/20 font-medium satoshi">
          Features
        </h1>
        <div>
          <div className="flex flex-col md:flex-row h-auto md:h-[45vh] border-b border-black/20 border-dashed divide-dashed">
            ...
            >
              ...
              <div className="absolute top-4 left-4 md:top-auto md:bottom-4 md:left-8">
                <h4 className="text-base md:text-lg font-medium text-black satoshi">
            ...
            >
              <div className="flex flex-row gap-4 w-full md:w-2/3 h-full">
                <div className="flex-1 border border-black/20 rounded-md overflow-hidden bg-[#e5ebe2] -rotate-4 -translate-y-1 group-hover:rotate-0 group-hover:translate-y-0 duration-300">
                  <h4 className="px-4 py-1 bg-black text-white border-b border-black/20 satoshi">
                    React.js
                  </h4>
              ...
              <div className="flex-1 flex items-center md:justify-center">
                <h4 className="text-base md:text-lg font-medium md:text-right satoshi">
          ...
          <div className="flex flex-col md:flex-row h-auto md:h-[45vh] divide-dashed">
            ...
            >
              <h4 className="md:text-center text-base md:text-lg font-medium w-full md:w-1/2 py-4 md:mx-auto md:mt-6 satoshi">
            ...
            >
              <h4 className="hidden md:block absolute left-4 top-18 text-center text-base md:text-lg font-medium -rotate-90 satoshi">
                Free
              </h4>
              <h4 className="hidden md:block absolute left-8 top-8 text-center text-base md:text-lg font-medium satoshi">
                & Open-Source
              </h4>
              <h4 className="absolute top-4 text-center text-base md:text-lg font-medium md:hidden satoshi">
    ...
    <div className="h-fit w-full md:w-[75vw] mx-auto border-x border-black/20 relative">
      <div className="flex divide-x divide-dashed divide-black/20">
        ...
        <div className="w-1/3 flex flex-col items-center justify-center py-8 md:py-16 hover:bg-[#B6CEB4] transition-colors duration-500 hover:duration-500 delay-300 hover:delay-0">
          <span className="text-2xl md:text-4xl font-bold satoshi">800+</span>
          <span className="mt-2 text-xs md:text-sm text-center satoshi">Weekly Downloads</span>
        </div>

        <div className="w-1/3 flex flex-col items-center justify-center py-8 md:py-16 hover:bg-[#B6CEB4] transition-colors duration-500 hover:duration-500 delay-300 hover:delay-0">
          <span className="text-2xl md:text-4xl font-bold satoshi">{stars !== null ? formatStars(stars) : "…"}</span>
          <span className="mt-2 text-xs md:text-sm text-center satoshi">Github Stars</span>
        </div>

        <div className="w-1/3 flex flex-col items-center justify-center py-8 md:py-16 hover:bg-[#B6CEB4] transition-colors duration-500 hover:duration-500 delay-300 hover:delay-0">
          <span className="text-2xl md:text-4xl font-bold satoshi"><Infinity/></span>
          <span className="mt-2 text-xs md:text-sm text-center satoshi">Happy users</span>
        </div>
      </div>
    </div>
    ...
    <div className="h-[8vh] w-full border-y border-black/20">
      <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-start items-end md:items-start px-4 py-2">
        <h1 className='md:hidden font-medium text-lg satoshi'>Guide:</h1>
      </div>
    </div>
      ...
      <div className="flex">
        <div className="divide-y divide-dashed divide-black/20 w-full md:w-2/3">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            <h3 className="font-medium text-base mb-2 satoshi">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
          >
            <h3 className="font-medium text-base mb-2 satoshi">Choose your template</h3>
            <CommandBlock
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
          >
            <h3 className="font-medium text-base mb-2 satoshi">Navigate to project</h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.3 }}
          >
            <h3 className="font-medium text-base mb-2 satoshi">Install Dependencies</h3>
    ...
    <div className="h-[8vh] w-full border-b border-black/20">
      <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-between items-center px-4">
        ...
        <Link href="/" className="flex justify-center items-center gap-1 cursor-pointer text-black/70 hover:scale-105 transition-transform duration-300">
