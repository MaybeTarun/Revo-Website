...
const reactTreeData: TreeViewElement[] = [
  {
    ...
    name: "src",
    children: [
      { id: "r1-1", name: "index.js" },
      { id: "r1-2", name: "App.js" },
      {
        id: "r1-3",
        name: "components",
        children: [
          { id: "r1-3-1", name: "Header.js" },
          { id: "r1-3-2", name: "Footer.js" },
        ],
      },
    ],
  },
  { id: "r2", name: "package.json" },
];
...
const nextTreeData: TreeViewElement[] = [
  {
    ...
    name: "pages",
    children: [
      { id: "n1-1", name: "index.tsx" },
      { id: "n1-2", name: "_app.tsx" },
      { id: "n1-3", name: "_document.tsx" },
    ],
  },
  { id: "n2", name: "next.config.js" },
];
...
export default function Home() {
  ...
  return (
    <div className="bg-white w-full min-h-screen flex flex-col">
      ...
      <div className="h-[8vh] w-full border-y border-black/20">
        <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-start items-end md:items-start px-4 py-2">
          <h1 className='md:hidden font-bold text-lg'>Features:</h1>
        </div>
      </div>
      ...
      <div className="h-fit w-full md:w-[75vw] mx-auto border-x border-black/20 relative">
        ...
        <div>
          <div className="flex flex-col md:flex-row h-auto md:h-[45vh] border-b border-black/20 border-dashed divide-dashed">
            ...
            <motion.div 
              ref={div2Ref}
              className="w-full md:w-3/5 p-4 flex flex-col-reverse md:flex-row gap-4"
              initial={{ x: 100, y: -100, opacity: 0 }}
              animate={allInView ? { x: 0, y: 0, opacity: 1 } : { x: 100, y: -100, opacity: 0 }}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
            >
              <div className="flex flex-row gap-4 w-full md:w-2/3 h-full">
                <div className="flex-1 border border-black/20 rounded-md overflow-hidden bg-white">
          ...
          <div className="flex flex-col md:flex-row h-auto md:h-[45vh] divide-dashed">
            ...
            >
              ...
              <div className="mx-auto w-full md:w-[80%] border border-b-0 border-black/20 h-[20vh] md:h-[25vh] flex flex-col">
                <div className="flex h-1/2">
                  <div className="w-2/5 bg-[#030712] flex items-center justify-center">
                    <Image src="/tcss.png" alt="TCSS" width={48} height={48} className="object-contain group-hover:scale-110 transition-transform duration-300 delay-50" />
                  </div>
                  <div className="w-3/5 bg-[#3178C6] flex items-end justify-end p-2">
                    <Image src="/ts.png" alt="TypeScript" width={64} height={64} className="object-contain group-hover:scale-110 transition-transform duration-300 delay-75" />
                  </div>
                </div>
                <div className="flex h-1/2">
                  <div className="w-1/5 bg-[#FF98A2] flex items-center justify-center">
                    <Image src="/lenis.png" alt="Lenis" width={86} height={86} className="object-contain group-hover:scale-110 transition-transform duration-300 delay-100" />
                  </div>
                  <div className="w-3/5 bg-[#f5f5f5] border border-y-0 border-black/20 flex items-center justify-center">
                    <Image src="/revo.svg" alt="RevoIcons" width={48} height={48} className="object-contain group-hover:scale-110 transition-transform duration-300 delay-75" />
                  </div>
                  <div className="w-2/5 bg-[#FFF32C] flex items-center justify-center">
                    <Image src="/motion.png" alt="Motion" width={64} height={64} className="object-contain group-hover:scale-110 transition-transform duration-300 delay-100" />
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ref={div4Ref}
              className="w-full md:w-1/3 h-[30vh] md:h-auto p-4 relative overflow-hidden"
              initial="hidden"
            ...
            >
              <h4 className="hidden md:block absolute left-0 top-14 text-center text-base md:text-lg font-medium -rotate-90">
                Free
              </h4>
              <h4 className="hidden md:block absolute top-4 text-center text-base md:text-lg font-medium">
                & Open-Source
              </h4>
              ...
              <motion.div
                variants={{
                  hidden: { y: "25%", rotate: 0 },
                  visible: { y: "25%", rotate: 0 },
                  hover: { y: 0, rotate: -6 },
                }}
    ...
    <div className="h-[8vh] w-full border-y border-black/20">
      <div className="h-full w-full md:w-[75vw] mx-auto border-x border-black/20 flex justify-start items-end md:items-start px-4 py-2">
        <h1 className='md:hidden font-bold text-lg'>Guide:</h1>
      </div>
    </div>
